...
**Install**
```
go get github.com/maritimeoptima/ApplicationInsights-Go/appinsights
```
...
[telemetry client](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#TelemetryClient).

```go
import "github.com/maritimeoptima/ApplicationInsights-Go/appinsights"
...
new [TelemetryConfiguration](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#TelemetryConfiguration)
...
The [TelemetryClient](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#TelemetryClient)
...
### Trace
[Trace telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#TraceTelemetry)
...
### Events
[Event telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#EventTelemetry)
...
[Metric telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#MetricTelemetry)
...
[pre-aggregated by the client](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#AggregateMetricTelemetry)
...
### Requests
[Request telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#RequestTelemetry)
...
### Dependencies
[Remote dependency telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#RemoteDependencyTelemetry)
...
### Exceptions
[Exception telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#ExceptionTelemetry)
...
### Availability
[Availability telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights/#AvailabilityTelemetry)
...
### Page Views
[Page view telemetry items](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights/#PageViewTelemetry)
...
[contracts.ContextTags](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights/contracts/#ContextTags)
...
[TelemetryContext](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights/#TelemetryContext)
...
import (
	...
	"github.com/maritimeoptima/ApplicationInsights-Go/appinsights"
...
### Shutdown
The Go SDK submits data asynchronously.  The [InMemoryChannel](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights/#InMemoryChannel)
...
through shutdown.
[The documentation](https://godoc.org/github.com/maritimeoptima/ApplicationInsights-Go/appinsights#TelemetryChannel)
